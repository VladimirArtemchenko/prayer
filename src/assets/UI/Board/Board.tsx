...
import {setCurrentBoardId} from '../../../store/currentBoardId/reducer';
import {ProfileScreenNavigationProp} from '../../../navigation/UserNavigator/Navigator';
import {BOARD_SCREEN_ROUTE} from '../../../navigation/UserNavigator/routes';
...
const Board: React.FC<BoardProps> = ({title, currentId, navigation}) => {
  ...
  const handleBoardClick = () => {
    ...
    navigation.navigate(BOARD_SCREEN_ROUTE);
  };
